...
const DeveloperSection = () => {
	const projects = [
		...
		},
		{
			...
			description:
				"Collaborative project management tool with real-time updates, drag-and-drop functionality, and team communication features.",
		...
		},
		{
			...
			description:
				"AI-powered content creation platform using OpenAI API. Generates blog posts, social media content, and marketing copy.",
		...
		},
		{
			...
			description:
				"Business intelligence dashboard with real-time data visualization, custom reports, and predictive analytics.",
		...
		},
		{
			...
			description:
				"Decentralized voting platform ensuring transparency and security using smart contracts and blockchain technology.",
	...
	const technologies = [
		...
		{ name: "JavaScript", icon: Code, color: "text-blue-300" },
			...
			<div className="container mx-auto px-6">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
						...
						From concept to deployment, I create solutions that solve real-world
						problems.
					</p>
				</div>
						...
						{technologies.map((tech) => {
							...
							return (
								<div
									...
									<IconComponent
										className={`mx-auto mb-3 ${tech.color}`}
										size={32}
									/>
