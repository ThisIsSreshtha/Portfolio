	...
	const writingProjects = [
		{
			...
			description:
				"Comprehensive 50-chapter guide covering React fundamentals to advanced patterns. Over 100,000 views and 500+ positive reviews.",
		...
		},
		{
			...
			description:
				"Rewrote API documentation for fintech startup, improving developer adoption by 200% and reducing support requests by 60%.",
		...
		},
		{
			...
			description:
				"Microcopy and UX writing for 15+ mobile applications. Focus on clarity, accessibility, and user-friendly language.",
		...
		},
		{
			...
			description:
				"Content strategy and writing for SaaS company blog. Increased organic traffic by 300% and generated 500+ qualified leads.",
		...
		},
		{
			...
			description:
				"Complete onboarding documentation for open-source project. Contributed to 40% faster developer setup and increased contributions.",
		...
		},
		{
			...
			description:
				"Series of white papers on blockchain technology, AI ethics, and cybersecurity for enterprise clients and industry publications.",
	...
	const writingServices = [
		{
			...
			description:
				"API docs, user guides, and developer resources that make complex topics accessible.",
			color: "text-blue-400",
		},
		{
			icon: Users,
			title: "UX Writing",
			description:
				"Microcopy, error messages, and interface text that guides users naturally.",
		...
		},
		{
			...
			description:
				"Blog posts, tutorials, and marketing content that drives engagement and growth.",
		...
		},
		{
			...
			description:
				"Editing and proofreading technical content for clarity, accuracy, and consistency.",
			...
			<div className="container mx-auto px-6">
				<div className="text-center mb-16">
					...
					<p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
						...
						I help companies communicate better with developers, users, and
						stakeholders.
					</p>
				</div>
				...
				<div className="mt-20 text-center">
					<div className="bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-2xl p-12 border border-orange-500/30">
						...
						<p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
							Let's work together to make your technical content clear,
